<div align="center">
  ...
  <h1>BharatData for Journalists</h1>
  <em>A practical guide to investigating Indian government data without writing code.</em>
</div>
...
> According to data from the National Crime Records Bureau, accessed via BharatData (bharatdata.org)...

**Data note at the end of a story:**
> **Data Sources:** Crime statistics from the National Crime Records Bureau (NCRB), Ministry of Home Affairs, Government of India. Data for 2023 from "Crime in India 2023" annual report. Accessed and normalized via BharatData (bharatdata.org). The platform does not modify any numerical values from original government publications.
...
<div align="center">
  <sub>Generated by the BharatData Team &nbsp;|&nbsp; Not affiliated with any government body &nbsp;|&nbsp; For press inquiries: press@bharatdata.org</sub>
</div>
