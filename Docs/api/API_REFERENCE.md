<div align="center">
  ...
  <h1>API Reference</h1>
  <em>Complete reference for the BharatData REST API v2.0</em>
</div>
...
```
Production:  https://api.bharatdata.org
...
```bash
curl https://api.bharatdata.org/v1/registry
```
...
```bash
curl https://api.bharatdata.org/v1/registry/ncrb-crime
```
...
```bash
curl https://api.bharatdata.org/v1/registry/ncrb-crime/fields
```
...
```bash
curl https://api.bharatdata.org/v1/registry/ncrb-crime/years
```
...
```bash
curl "https://api.bharatdata.org/v1/data/ncrb-crime?entity=Maharashtra&year=2023&limit=10"
```
...
```bash
curl -X POST https://api.bharatdata.org/v1/ai/query \
...
```bash
curl https://api.bharatdata.org/v1/meta/states
```
...
```bash
curl https://api.bharatdata.org/v1/fallback
```
...
<div align="center">
  <sub>Generated by the BharatData Team &nbsp;|&nbsp; Not affiliated with any government body &nbsp;|&nbsp; API v2.0.0</sub>
</div>
